...
export default function BowlerPanel({ computed, onChangeBowler }) {
      ...
      <div>
        ...
        {bowler && (
          <p className="mt-0.5 font-tabular text-sm text-ink-soft dark:text-ink-darksoft">
            {Math.floor(bowler.legalBalls / 6)}.{bowler.legalBalls % 6}-{bowler.maidens}-{bowler.runs}-{bowler.wickets} · Econ {bowler.economy}
          </p>
        )}
      </div>
